[size=6][center]Ties that Bind (Lazos que Unen)
Traducción al castellano[/center][/size]
...
Del creador de [url=http://www.nexusmods.com/fallout3/mods/14449]The Institute[/url], Ties that Bind (Lazos que Unen) es un mod que añade un seguidor que supera a cualquier otro. Además de añadir su propio contenido, expande la experiencia de juego original añadiendo a Amanda: tu hermana.
...
Requisitos
[list]
[*][url=http://fose.silverlock.org/]Fallout Script Extender (FOSE)[/url]
[*][url=http://www.nexusmods.com/fallout3/mods/19941]Ties that Bind - a narrative companion mod[/url] (el mod original en inglés)
[/list]
...
[color=#ff0000][b]NOTA DEL TRADUCTOR[/b]: [color=#efefef]A pesar de lo que dice el readme del autor original, [i]de que se recomienda[/i] iniciar una partida nueva... en mi experiencia diria que es imprescindible. Creo que hay un bug por el cual si usas una partida ya empezada, no aparece un NPC esencial en Paradise Falls para iniciar la quest.[/color][/color][color=#efefef]
[/color]
